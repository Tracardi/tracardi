...
class MemoryCacheConfig:
    def __init__(self, env):
        self.event_to_profile_coping_ttl = get_env_as_int('EVENT_TO_PROFILE_COPY_CACHE_TTL', 15)
        self.source_ttl = get_env_as_int('SOURCE_CACHE_TTL', 30)
        self.event_validation_cache_ttl = get_env_as_int('EVENT_VALIDATION_CACHE_TTL', 15)
        self.data_compliance_cache_ttl = get_env_as_int('DATA_COMPLIANCE_CACHE_TTL', 30)
        self.event_mapping_cache_ttl = get_env_as_int('EVENT_METADATA_CACHE_TTL', 15)
        self.trigger_rule_cache_ttl = get_env_as_int('TRIGGER_RULE_CACHE_TTL', 15)
        self.event_destination_cache_ttl = get_env_as_int('EVENT_DESTINATION_CACHE_TTL', 15)
        self.profile_destination_cache_ttl = get_env_as_int('PROFILE_DESTINATION_CACHE_TTL', 15)
        self.event_reshaping_cache_ttl = get_env_as_int('EVENT_RESHAPING_CACHE_TTL', 15)
        self.identification_points_cache_ttl = get_env_as_int('IDENTIFICATION_POINTS_CACHE_TTL', 15)
        self.resource_load_cache_ttl = get_env_as_int('RESOURCE_LOAD_CACHE_TTL', 15)
