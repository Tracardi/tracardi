...
class MemoryCacheConfig:
    def __init__(self):
        self.default_ttl = 180  # Check every 60 sec
        ...
        self.event_validation_cache_ttl = _get_random_value(get_env_as_int('EVENT_VALIDATION_CACHE_TTL', self.default_ttl))
        self.data_compliance_cache_ttl = _get_random_value(get_env_as_int('DATA_COMPLIANCE_CACHE_TTL', self.default_ttl))
        ...
        self.event_reshaping_cache_ttl = _get_random_value(get_env_as_int('EVENT_RESHAPING_CACHE_TTL', self.default_ttl))
...
class TracardiConfig(metaclass=Singleton):
    ...
    def __init__(self, env):
        ...
        self.metadata_data_adapter = env.get('META_DATA_ADAPTER', 'mysql')
