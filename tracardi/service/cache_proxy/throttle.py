...
class Throttler:
    ...
    async def call(self, max_no_execution, func: Callable[..., Awaitable[Any]], *args, **kwargs) -> Any:
        ...
        if self._not_cached(key) or self._is_overdue(key, current_time, max_no_execution) or not self._is_throttled(current_time):
