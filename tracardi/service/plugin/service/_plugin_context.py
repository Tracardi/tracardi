...
#         "session": plugin.session.to_dict() if plugin.session else None,
...
#             plugin.session = FlatSession(context['session'])
#         else:
#             plugin.session.replace(FlatSession(context['session']))
#
