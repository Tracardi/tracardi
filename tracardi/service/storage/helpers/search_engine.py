...
from tracardi.service.storage.sql import to_time_range_sql_query
from tracardi.process_engine.tql.parser import Parser
from tracardi.process_engine.tql.transformer.filter_transformer import FilterTransformer
from tracardi.service.storage.driver import storage

_logger = logging.getLogger("SearchEngine")


class SqlFilterParser(metaclass=Singleton):
    def __init__(self):
