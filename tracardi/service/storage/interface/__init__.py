...
if tracardi.storage_driver == 'elasticsearch':
    from tracardi.service.storage.interface.elastic.collector.mutation import profile as profile_mutation_collector_dao
    from tracardi.service.storage.interface.elastic.collector.load import profile as profile_load_collector_dao
    from tracardi.service.storage.interface.elastic.gui import profile as profile_gui_dao
