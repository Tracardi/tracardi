...
# async def load_duplicated_profiles_with_ids(profile_ids: List[str]) -> List[Profile]:
#     query = {
#         "size": 10000,
#         "query": {
#             "bool": {
...
# async def load_duplicated_profiles_with_merge_key(merge_key_values: List[tuple],
#                                  condition: str = 'must',
