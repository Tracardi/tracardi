...
# async def load_by_id(id) -> Optional[EventDataCompliance]:
#     return EventDataCompliance.create(await storage_manager("consent-data-compliance").load(id))
...
# async def upsert(compliance_setting: EventDataCompliance) -> BulkInsertResult:
