...
data = {
    "nodes": [
        {"id": "n1", "outputs": ["TRUE", "FALSE"], "inputs": [], "className": "task1",
         "module": 'app.tests.manual.plugins.plugins', "init": {"condition": "abc"}},

        {"id": "n2", "outputs": ["NODE2_o"], "inputs": ["NODE2_i"], "className": "task2",
         "module": 'app.tests.manual.plugins.plugins'},
        ...
        {"id": "n4", "outputs": ["NODE4_o"], "inputs": ["NODE4_2_i", "NODE4_3_i", "NODE4_1_i"], "className": "task4",
         "module": 'app.tests.manual.plugins.plugins'},
        {"id": "n5", "outputs": ["NODE5_i"], "inputs": [], "className": "task5", "module": 'app.tests.manual.plugins.plugins'}
